...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='./datasets2000')
    parser.add_argument('--model_dir', type=str, default='./model')
    parser.add_argument('--crowd_dir', type=str, default='/train_data/CrowdNpy/KT1_crowd_total_finally.npy')
    parser.add_argument('--truth_dir', type=str, default='/train_data/KT1_truth_train.txt')
    ...
    parser.add_argument('-a_dim', '--annotator_dim', type=int, default=1000)
    parser.add_argument('-t_dim', '--task_dim', type=int, default=1000)
