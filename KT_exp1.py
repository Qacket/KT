...
if __name__ == '__main__':
    main_dir = r'./datasets2000'
    crowd_file = main_dir + '/test_data/KT1_crowd_test.txt'
    truth_file = main_dir + '/test_data/KT1_truth_test.txt'
    ...
    data_scale_range = range(1000, 2000, 1000)
    max_sampling_time = 3
    max_generate_sum = 3
    pool = Pool()
    ...
    train_data = KT(
        data_dir=main_dir,
        crowd_dir='/test_data/CrowdNpy/KT1_crowd_total_finally.npy'
    )
        ...
        for i in range(max_sampling_time):
            ...
            for generate_method_name in generate_methods:  # 一个样本文件在 每个生成方法下生成数据
                for j in range(max_generate_sum):
                    generate_file = main_dir + '/KT1_1/' + str(number) + '/' + generate_method_name + '/' + str(i) + '_' + str(j) + '.txt'
    ...
    #
    #     mean_KL_list = []
    #     mean_KL_path = main_dir + '/KT1_1/KL/KL_mean_' + str(z) + '.csv'
    #     std_KL_list = []
    #     std_KL_path = main_dir + '/KT1_1/KL/KL_std_' + str(z) + '.csv'
    #
    #     mean_KS_stat_list = []
    #     mean_KS_stat_path = main_dir + '/KT1_1/KS/KS_stat_mean_' + str(z) + '.csv'
    #     std_KS_stat_list = []
    #     std_KS_stat_path = main_dir + '/KT1_1/KS/KS_stat_std_' + str(z) + '.csv'
    #
    #     mean_KS_pval_list = []
    #     mean_KS_pval_path = main_dir + '/KT1_1/KS/KS_pavl_mean_' + str(z) + '.csv'
    #     std_KS_pval_list = []
    #     std_KS_pval_path = main_dir + '/KT1_1/KS/KS_pavl_std_' + str(z) + '.csv'
    #
    ...
    #
    #             KL_list = []
    #             KL_path = main_dir + '/KT1_1/' + str(number) + '/' + generate_method_name + '/KL_total_' + str(z) + '.csv'
    #
    #             KS_stat_list = []
    #             KS_stat_path = main_dir + '/KT1_1/' + str(number) + '/' + generate_method_name + '/KS_stat_total_' + str(z) + '.csv'
    #             KS_pval_list = []
    #             KS_pval_path = main_dir + '/KT1_1/' + str(number) + '/' + generate_method_name + '/KS_pval_total_' + str(z) + '.csv'
    #             for i in range(max_sampling_time):
    #                 for j in range(max_generate_sum):
    #                     generate_file = main_dir + '/KT1_1/' + str(number) + '/' + generate_method_name + '/' + str(i) + '_' + str(j) + '.txt'
